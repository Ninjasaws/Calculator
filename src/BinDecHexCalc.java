...
public class BinDecHexCalc extends Bandwidth {
     ...
     * @return String resturns a Hexadecimal in the form of a Decimal
     */
...
//    }
    ...
    // Maybe will use this method, not sure atm
    public static void input(String input1, char operator, String input2,String webResult) throws Exception {
